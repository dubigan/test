...
const functions: TListFunctions = {
  cars: {
    ...
    getTable: function getTable(items: TCarItem[], getButtons: Function, onClick: TOnClick, sortedBy: TSortedBy) {
      return (
  ...
  owners: {
    ...
    getTable: function getTable(items: TOwnerItem[], getButtons: Function, onClick: TOnClick, sortedBy: TSortedBy) {
      return (
        <Table className="table table_striped table_bordered table_hover">
          <thead>
            <tr>
