...
const OwnerDetail = () => {
  const functions = useDetailFunctions(E_DETAIL.OWNER);
  ...
  return (
    <div>
            ...
            <div className="form">
              <Form.Group className="form__group form__group_owner-input">
                ...
                <TextField
                  ...
                  onChange={detailUtils.changeItem}
                />
                <GenderSelect name="gender" checkValue={detailUtils.item!.gender} onChange={changeGender} />
                <TextField
                  name="age"
                  maxLength={3}
                  placeholder="Возраст"
      ...
      <Card>
        ...
        <Card.Body>
          <Cars withAlerts={false} owner={detailUtils.item?.id} functions={carFunctions as TItemFunctions<TCarItem>} />
        </Card.Body>
      </Card>
    </div>
  );
